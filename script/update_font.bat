...
if "%MAJSOUL_LANG%" == "jp" (
  utils\fontbm\fontbm.exe --font-file fonts\NotoSansCJKkr-Medium.otf --output src\generated\fonts\jp_haolong --chars-file src\generated\chars.txt --data-format xml --max-texture-count=1 --texture-width=1536 --texture-height=2096 --font-size=40
  utils\fontbm\fontbm.exe --font-file fonts\NotoSansCJKkr-Medium.otf --output src\generated\fonts\jp_jiye --chars-file src\generated\chars.txt --data-format xml --max-texture-count=1 --texture-width=1024 --texture-height=2096 --font-size=35
) else (
